          ...
          <div className={styles.hero_text}>
            ...
            <div className={styles.hero_paragraph}>
              <p>
                ...
                línea, puedes decir adiós a las largas esperas y reservar tu
                cita en solo unos pocos clics. Nuestro equipo de estilistas
                altamente capacitados está listo para brindarte el servicio que
                mereces, todo mientras te ahorramos tiempo y te ofrecemos la
